  ...
  return (
    <View style={tw`flex h-5/7 items-center justify-center`}>
      ...
      >
            ...
            <View style={tw`flex items-center justify-center mt-35`}>
              <View style={tw`flex items-center justify-center bg-gray-300 rounded-lg w-80 h-90`}>
                ...
                <View style={tw`h-4/10 w-8/10 flex flex-row items-center justify-evenly`}>
                  <View
                    style={tw`flex flex-col justify-center items-center h-25 w-22 ${dataModal[0]?.hemisphere?.asserted ? "bg-green-400" : "bg-red-400"} rounded-lg mr-5`}
                  >
                    ...
                    <Text style={tw`text-sm`}> {dataModal[0]?.hemisphere?.hemisphere ? dataModal[0]?.hemisphere?.hemisphere : dataModal[0]?.hemisphere?.tryHemisphere} </Text>
                  </View>
                  <View
                    style={tw`flex flex-col justify-center items-center h-25 w-22 ${dataModal[0]?.continent?.asserted ? "bg-green-400" : "bg-red-400"} rounded-lg mr-5`}
                  >
                    <View style={tw`h-7 w-7`}>
                      <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <Path
                    ...
                    <Text style={tw`text-sm text-center`}> {dataModal[0]?.continent?.tryCont ? dataModal[0]?.continent?.tryCont : dataModal[0]?.continent?.continent } </Text>
                  </View>
                  <View
                    style={tw`flex flex-col justify-center items-center h-25 w-22 ${dataModal[0]?.area?.arrowdirection === "down" ? "bg-red-400" : (dataModal[0]?.area?.arrowdirection === "up" ? "bg-red-400" : "bg-green-400")} rounded-lg`}
                  >
                    <View style={tw`h-7 w-7`}>
                      <Svg
                    ...
                    <Text style={tw`text-sm`}> {dataModal[0]?.area?.arrowdirection === "down" ? "Less" : (dataModal[0]?.area?.arrowdirection === "up" ? "More" : `${dataModal[0]?.area?.area}km²`)} </Text>
                  </View>
                </View>
                <View style={tw`h-4/10 w-8/10 flex flex-row items-center justify-evenly`}>
                  <View
                    style={tw`flex flex-col justify-center items-center h-25 w-25 ${dataModal[0]?.population?.arrowDirection === "down" ? "bg-red-400" : (dataModal[0]?.population?.arrowDirection === "up" ? "bg-red-400" : "bg-green-400")} rounded-lg mr-5`}
                  >
                    <View style={tw`h-7 w-7`}>
                    ...
                    <Text style={tw`text-sm`}> {`${dataModal[0]?.population?.arrowDirection === "down" ? "Less" : (dataModal[0]?.population?.arrowDirection === "up" ? "More" : dataModal[0]?.population?.population)}`} </Text>
                  </View>
                  <View
                  ...
                  >
                    ...
                    <Text style={tw`text-sm`}> {dataModal[0]?.coordinates?.direction} </Text>
                  </View>
                </View>
        ...
        {listOfAttemps?.map((el) => {
          return (
            <View key={el.name} style={tw`flex flex-col`}>
              <Pressable key={el.name} onPress={(e) => {setModalVisible(true); onModal(el.name)}}>
              <Text style={tw`mt-2 text-center text-white font-bold text-lg`}>{el.name}</Text>
                <View
                  key={el.name}
        ...
        { display === true ? <Text style={tw`mt-2 text-center text-white font-bold text-xl`}>{
                        `The country was:
${countryOfGame.name}`}
                        </Text>
        : <></>}
