...
export default function Footer() {
  ...
  return (
    <View style={tw`flex h-1/6 items-center justify-center`}>
      <View style={tw`flex flex-row justify-evenly items-center w-full bg-[#C0D6DF] shadow-xl rounded-t-3xl h-25 pb-5`}>
          <View style={tw`flex items-center justify-center rounded-lg`}>
            ...
            >
              <View style={tw`flex items-center justify-center mt-75`}>
                <View style={tw`flex items-center justify-evenly bg-[#C0D6DF] rounded-xl w-60 h-40`}>
                  ...
                  <View style={tw`flex flex-row items-center`}>
                    <TouchableOpacity
                      style={tw`rounded-lg bg-green-400 w-10 pt-1 pb-1 pr-2 pl-2 mr-10`}
                      onPress={(e) => {setModalVisible(!modalVisible); handleGiveUp(e); touchSound(soundOn);}}
                    >
                      <Text style={tw`text-sm text-center font-bold text-white`}>{isSpanish?"Si":"Yes"}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      style={tw`rounded-lg bg-red-400 w-10 pt-1 pb-1 pr-2 pl-2`}
                      onPress={() => {setModalVisible(!modalVisible); backSound(soundOn)}}
                    >
                      <Text style={tw`text-sm text-center font-bold text-white`}>{isSpanish?"No":"No"}</Text>
                    </TouchableOpacity>
                  </View>
                </View>
              </View>
        ...
        <TouchableOpacity
          style={tw`flex justify-center items-center px-8 rounded-lg mr-5 w-10 h-15`}
        ...
        />
        <TouchableOpacity
          style={tw`flex justify-center items-center px-8 rounded-lg w-10 h-15`}
