...
export default function Ranking() {
  ...
  const rank = [{label: isSpanish ? "Ranking completo" : "All Ranks", value: "All Ranks"}, { label: "1 - 50", value: "1 - 50" },{ label: "51 - 100", value: "51 - 100" },{ label: "101 - 150", value: "101 - 150" },{ label: "151 - 200", value: "151 - 200" },{ label: "201 - 250", value: "201 - 250" },{ label: "251 - 300", value: "251 - 300" },{ label: "301 - 350", value: "301 - 350" },{ label: "351 - 400", value: "351 - 400" },{ label: "401 - 450", value: "401 - 450" },{ label: "451 - 500", value: "451 - 500" }];
