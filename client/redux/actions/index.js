...
export function getGame(id){
    return async function(dispatch){
        try{
            var json = await axios.get("https://world-game-v3.herokuapp.com/games", id)
            return dispatch({
                type: type.GET_GAME,
                payload : json.data,
            })
...
export function PostGame(payload){
    return async function(dispatch){
        try{
            const response = axios.post("https://world-game-v3.herokuapp.com/games", payload)
            return response
...
export function postLogin(payload){
    return async function(dispatch){
        try{
            var json = await axios.post("https://world-game-v3.herokuapp.com/Login", payload)
            return dispatch({
...
export function getRank(payload){
    return async function(dispatch){
        try{
            var json = await axios.get("https://world-game-v3.herokuapp.com/User/rank", {total: payload})
            return dispatch({
                type: type.GET_RANK,
...
export function getUser(id) {
    return async function (dispatch) {
        try {
            if (id) {
                var json = await axios.get("https://world-game-v3.herokuapp.com/User/" + id)
            }
            else {
...
export function PostUser(payload){
    return async function(dispatch){
        try{
            var json = await axios.post("https://world-game-v3.herokuapp.com/User", payload)
...
export function PutUser(payload){
    return async function(dispatch){
        try{
            var json = await axios.put("https://world-game-v3.herokuapp.com/User", payload)
            return dispatch({
                type: type.PUT_USER,
                payload : json.data,
            })
...
export function deleteUser(payload){
    return async function(dispatch){
        try{
            const response = axios.delete(`https://world-game-v3.herokuapp.com/User/delete/recycle/${payload}`)
            return response
        }catch(e){
            return e.message
        }
...
export function restoreUser(payload){
    return async function(dispatch){
        try{
            const response = axios.delete(`https://world-game-v3.herokuapp.com/User/delete/restore/${payload}`)
            return response
        }catch(e){
            return e.message
        }
...
export function PostFriend(payload){
    return async function(dispatch){
        try{
            const response = axios.post("https://world-game-v3.herokuapp.com/friends", payload)
            return response
...
export function getCountrie(name){
    return async function(dispatch){
        try{
            var json = await axios.get("https://world-game-v3.herokuapp.com/countries",name)
            return dispatch({
    ...
    export function getAllCountries(form = false){
        return async function(dispatch){
            try{
                var {data} = await axios.get("https://world-game-v3.herokuapp.com/countries")
                if(!form){ 
            return dispatch({
