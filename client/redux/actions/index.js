...
export function getRank(payload) {
  return async function (dispatch) {
    try {
      var json = await axios.get(
        "http://192.168.1.72:3001/User/rank/",
        { total: payload }
      );
      return dispatch({
        type: type.GET_RANK,
...
export function getUser(id) {
  return async function (dispatch) {
    try {
      if (id) {
        var json = await axios.get(
          "http://192.168.1.72:3001/User/" + id
        );
        return dispatch({
          type: type.GET_USER,
          payload: json.data,
        ...
        var json = await axios.get("http://192.168.1.72:3001/User/");
        return dispatch({
...
//             return await axios.post("http://192.168.1.72:3001/User", payload)
  ...
  return async function (dispatch) {
    try {
      const response = axios.delete(
        `http://192.168.1.72:3001/User/delete/recycle/${payload}`
      );
      return response;
    } catch (e) {
      return e.message;
...
export function restoreUser(payload) {
  return async function (dispatch) {
    try {
      const response = axios.delete(
        `http://192.168.1.72:3001/User/delete/restore/${payload}`
      );
      return response;
    } catch (e) {
      return e.message;
...
export function searchFriend(friend){
  ...
  return async function (dispatch) {
    try {
        ...
        var {data} = await axios.get("http://192.168.1.72:3001/User/");
        return dispatch({
...
export function getCountrie(name) {
  return async function (dispatch) {
    try {
      var json = await axios.get(
        "http://192.168.1.72:3001/countries",
        name
      );
      return dispatch({
