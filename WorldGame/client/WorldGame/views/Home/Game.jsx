    ...
    <View style={tw`flex h-6/8 items-center justify-center`}>
      <ScrollView>
        {listOfAttemps?.map(el => {
          return (
            <View key={el.name} style={tw`flex flex-row justify-center items-center mb-3 mt-3`}>
            <View
              style={tw`flex justify-center items-center ${el.hemisphere.asserted ? "bg-green-600" : "bg-red-600"} h-10 w-10 rounded-md mr-5`}
            >
            ...
            <View
              style={tw`flex justify-center items-center ${el.continent.asserted ? "bg-green-600" : "bg-red-600"} h-10 w-10 rounded-md mr-5`}
            >
              <View style={tw`h-7 w-7`}>
                <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <Path
            ...
            <View
              style={tw`flex justify-center items-center ${el.area.arrowdirection == "up" ? "bg-red-600" : (el.area.arrowdirection == "down" ? "bg-red-600" : "bg-green-600")} h-10 w-10 rounded-md mr-5`}
            >
              <View style={tw`h-7 w-7`}>
                <Svg
            ...
            <View
              style={tw`flex justify-center items-center ${el.population.arrowDirection == "up" ? "bg-red-600" : (el.population.arrowDirection == "down" ? "bg-red-600" : "bg-green-600")} h-10 w-10 rounded-md mr-5`}
            >
              <View style={tw`h-7 w-7`}>
            ...
            <View
              style={tw`flex justify-center items-center ${el.coordinates.direction.length > 0 ? "bg-red-600" : "bg-green-600"} h-10 w-10 rounded-md`}
            >
              <View style={tw`h-7 w-7`}>
                <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  <Path
