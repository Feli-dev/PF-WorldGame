    ...
    <View style={tw`flex h-7/9 items-center justify-center bg-gray-900`}>
      <ScrollView>
        <View style={tw`flex flex-row justify-center items-center mb-3 mt-3`}>
          <View
            style={tw`flex justify-center items-center bg-green-600 h-10 w-10 rounded-md mr-5`}
          >
          ...
          <View
            style={tw`flex justify-center items-center bg-yellow-600 h-10 w-10 rounded-md mr-5`}
          >
            <View style={tw`h-7 w-7`}>
              <Svg
          ...
          <View
            style={tw`flex justify-center items-center bg-red-600 h-10 w-10 rounded-md mr-5`}
          >
            <View style={tw`h-7 w-7`}>
          ...
          <View
            style={tw`flex justify-center items-center bg-red-600 h-10 w-10 rounded-md`}
          >
            <View style={tw`h-7 w-7`}>
              <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <Path
        ...
        <View style={tw`flex flex-row justify-center items-center mb-3 mt-3`}>
          ...
          <View
            style={tw`flex justify-center items-center bg-yellow-600 h-10 w-10 rounded-md`}
          >
            <View style={tw`h-7 w-7`}>
              <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <Path
        ...
        <View style={tw`flex flex-row justify-center items-center mb-3 mt-3`}>
          ...
          <View
            style={tw`flex justify-center items-center bg-green-600 h-10 w-10 rounded-md`}
          >
            <View style={tw`h-7 w-7`}>
              <Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                <Path
