...
export default function Instructions() {
    ...
    return(
        ...
        <ScrollView
            ...
            <View style={estiloView}>
            <Text style={styleText}>Go to the search bar on the bottom and write the name of any country</Text>
            ...
            <View style={estiloView}>
            <Text style={tw`m-5 text-white text-center text-2xl font-bold`}>Ready! </Text>    
